...
<span style="font-family: 'Space Grotesk', sans-serif; font-size: 2.0rem; letter-spacing: 0.02em; text-transform: uppercase; color: #9e9a88;">RF Heating Internship @ Commonwealth Fusion Systems</span>
...
<span style="font-family: 'Space Grotesk', sans-serif; font-size: 2.0rem; letter-spacing: 0.02em; text-transform: uppercase; color: #9e9a88;">Raspberry Pi Data Acquisition System</span>
